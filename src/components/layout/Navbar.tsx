      ...
      >
        <div className="container-wide flex items-center justify-between h-20 px-6 md:px-8 lg:px-12">
          ...
          <a href="#" className="flex items-center gap-2.5 shrink-0">
            <img src={`${import.meta.env.BASE_URL}logo.jpg`} alt="Heaven Fitness Logo" className="h-10 w-10 object-contain" />
            <span className="font-logo text-xl font-semibold tracking-tight text-white hidden sm:block">
              Heaven Fitness
            </span>
          </a>
